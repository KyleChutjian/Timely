        ...
        {courses.map((course, index) => (
          <div key={index} className="col">
            <div className="card mb-4 dashCard">
              <img
                class="card-img-top"
                src="https://i.ibb.co/L9rb20M/classroom.jpg"
                alt="Course Image"
              />
              ...
              {this.props.professor && (
                <Link to="/data">
                  <button
                    type="button"
                    className="btn mb-3 my-1 btn-primary rounded button "
                    style={{ width: "92%" }}
                  >
                    View Data
                  </button>
              ...
              {!this.props.professor && (
                <Link
                  to="/dashStudent"
                  state={[course, user, courseId, professor]}
                >
                  <button
                    type="button"
                    className="btn  mb-3  btn-primary rounded button"
                    style={{ width: "92%" }}
